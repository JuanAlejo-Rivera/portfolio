    ...
    <section className="py-20 px-6 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-800 rounded-xl p-6 shadow-lg">
          ...
          <p className="text-gray-300">
            Busco mi <span className="font-semibold">primer empleo como desarrollador junior</span>.  
            Mi meta: fortalecer mis habilidades técnicas, aportar valor en proyectos reales y crecer profesionalmente en 
            equipos dinámicos.
          </p>
        </div>
