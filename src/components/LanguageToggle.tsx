...
export default function LanguageToggle() {
  ...
  return (
    ...
    >
      ...
      <span 
        className={`relative z-10 text-md font-semibold transition-all duration-300 ${
          currentLang === 'es' 
